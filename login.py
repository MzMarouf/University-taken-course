...
class User:
    def __init__(self, username, password, role=None, student_name=None, student_lastname=None, student_number=None,
                 major=None, major_code=None):
        ...
        while True:
            ...
            if username in lst_username:
                ...
                while n < 3:
                    ...
                    hash_password = hashlib.sha256(password.encode("utf8")).hexdigest()
                    if hash_password in lst_password:
