...
class Student(User):
    def __init__(self, student_name, student_lastname, student_number, major, major_code, username, password,
                 role, status=True):
        ...
        super().__init__(student_name, student_lastname, student_number,
                         username, password, major, major_code, role)
    ...
    """
    def choose_course(self, course_name, professor, course_id, unit, capacity, major, major_id):
